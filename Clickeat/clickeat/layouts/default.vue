        ...
        <v-row class="d-flex justify-space-around" no-gutters>
          <v-container fluid>
            <v-row class="d-flex justify-space-around mt-5" no-gutters>
              <!-- Logo -->
              <v-col class="hidden-md-and-down" cols="9">
                <v-btn fab dark color="orange" to="/">
                  <v-icon dark> Click'eat! </v-icon>
                </v-btn>
              </v-col>
              ...
              <v-col cols="2" class="mt-2">
                ...
                >
                  ...
                  >
                    <ul
                      v-if="$store.getters.getCart.length != 0"
                      style="list-style: none"
                    >
                      <li
                        v-for="(article, index) in $store.getters.getCart"
                        :key="index"
                        class="white"
                      >
                        <v-row class="mt-2">
                        ...
                        <v-row>
                          <v-col>
                            <p class="orange--text text-h5 font-weight-bold">
                              {{ article.price + '€' }}
                            </p>
                          </v-col>
                          <v-col>
                    ...
                    <div v-else>
                      <p class="font-italic font-weight-bold text-h6 ml-1">
              ...
              <v-col cols="1" class="mt-2">
                ...
                <btncompte class="hidden-md-and-down" text="Mon compte" />
                <btncompte class="hidden-md-and-up" text="" />
              </v-col>
            </v-row>
          </v-container>
        </v-row>
    ...
    >
      <v-row class="white--text mt-1">
        <v-col class="mb-3 ml-5 p-0">
          <v-btn class="mb-7 ml-15" fab dark x-large color="orange">
            <v-icon style="width: 20%" dark> Click'eat! </v-icon> </v-btn
          ><br />
        ...
        <v-col class="mb-3 p-0">
          ...
          <p>
            L'ensemble de notre service est disponible 24/24 et 7/7 pour
            répondre à votre estomac <span style="width: 200%">🍱</span>
          </p>
        </v-col>
        <v-col class="mb-3 p-0">
          ...
          <NuxtLink
            ...
            >Comment fonctionne le parrainage ?</NuxtLink
          ><br />
          <NuxtLink
            class="font-weight-bold white--text"
            to="/partner"
...
export default {
  ...
  methods: {
    ...
    removeArticle(article, index) {
      ...
      this.$axios
        .delete('http://localhost:8000/articles/cart/delete/' + article._id)
        .then(function () {})
    },
